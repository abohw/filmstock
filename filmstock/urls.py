...
urlpatterns = [
    ...
    path('film/<int:id>/<str:brand>/<str:name>/', views.viewFilmStock),
    path('film/<int:id>/<str:brand>/<str:name>/<str:format>/<int:exposures>/', views.viewFilmStock),
    path('film/<int:id>/<str:brand>/<str:name>/<str:format>/', views.viewFilmStock),
